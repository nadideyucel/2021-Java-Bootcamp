...
public class UcakBiletFiyatHesapla {
    public static void main(String[] args) {
        ...
        System.out.print("Yolculuk tipi seciniz (1-Tek Yonlu ucus||2-Gidiş Dönüş): "); int secim = sc.nextInt();
        if(km>0 && yas>0 && secim==1 || secim==2){
            ...
            if(yas<12 && secim==1){
             ...
             //   baslangicFiyati = (indirimliTutar-donusIndirim)*2;
                  baslangicFiyati = (int)(indirimliTutar*0.20);
                int  toplamTutar=indirimliTutar-donusIndirim;
